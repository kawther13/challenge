...
@Entity
public class ListeGagnantAgent {
   ...
   private String product;
    ...
    public ListeGagnantAgent() {

    }

    public ListeGagnantAgent(Long id, String nom, String product, String contractType, String transactionNature, int nbrContrat, double prime, String nomAgence, String nomRegion, LocalDate dateTransaction,String packType, Long challengeId) {
        this.id = id;
        this.nom = nom;
